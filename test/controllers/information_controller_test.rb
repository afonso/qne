...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { city: @information.city, expected_finish: @information.expected_finish, occupation: @information.occupation, school: @information.school, state: @information.state, user_id: @information.user_id, work_at: @information.work_at }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { city: @information.city, expected_finish: @information.expected_finish, occupation: @information.occupation, school: @information.school, state: @information.state, user_id: @information.user_id, work_at: @information.work_at }
    assert_redirected_to information_path(assigns(:information))
  end
